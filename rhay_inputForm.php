			...
			<table>
				...
				<tr>
					<td bgcolor="LIGHTGRAY" height="40" width="100">
						<a href="rhay_cparSummary.php"><center><?php echo displayText('L1724');//Previous Page?></center></a>
					</td>
					<td width='500'>
			...
			<div class="art-post-inner art-article">
				...
				<table border="2">
					...
					<td width="800">
						...
						<input type = "radio" name = "sourceInfo" class = "radios" value = "CPAR-SUP_Supplier" onclick="selectShow();" required><?php echo displayText(displayText('L367','utf8',0,0,1),'utf8',0,1,1);?>&nbsp;<input list = "list" name = "inputSupplierSubCon" id="inputName" style = "border-radius:5px; width:50%;" required/>
							 <datalist id = 'list'>
								<?php
						...
						<input type = "radio" name = "sourceInfo" class = "radios" value = "CPAR-SUB_Subcon" required><?php echo displayText(displayText('L91','utf8',0,0,1),'utf8',0,1,1);?><br>
						
<!--					Commented By Gerald 2018-06-04
						<input type = "radio" name = "sourceInfo" class = "radios" value = "CPAR-CUS_Customer Claim" onclick="hideShow();" required><?php echo displayText(displayText('L1232','utf8',0,0,1),'utf8',0,1,1);?>&nbsp;&nbsp;&nbsp;&nbsp;<input type = 'text' name = 'customerHide' id = 'cHide' style = "display:none; width:20%;"><br>
-->
						<?php
							if($_SESSION['idNumber']=='0346' OR $_SESSION['idNumber']=='0377')
							{
								?>
								<input type = "radio" name = "sourceInfo" class = "radios" value = "CPAR-SYS_Internal Audit" required><?php echo displayText(displayText('L3458','utf8',0,0,1),'utf8',0,1,1);?><br>
								<input type = "radio" name = "sourceInfo" class = "radios" value = "CPAR-SYS_Others" required><?php echo displayText(displayText('L1104','utf8',0,0,1),'utf8',0,1,1);?>
								<?php
							}
							else
							{
								?>
								<input type = "radio" name = "sourceInfo" class = "radios" value = "CPAR-SYS_System" id = "system" required><?php echo displayText(displayText('L1233','utf8',0,0,1),'utf8',0,1,1);?>
								<?php
							}
						?>
					</td>
  ...
  function redirect() {
	...
	$(function(){
		...
		$(".radios").change(function(){
			if($(this).val() == 'CPAR-SYS_System' || $(this).val() == 'CPAR-SYS_Internal Audit' || $(this).val() == 'CPAR-SYS_Others')
			{
